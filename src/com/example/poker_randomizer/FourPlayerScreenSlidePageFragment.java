...
public class FourPlayerScreenSlidePageFragment extends Fragment implements
	...
	public static final FourPlayerScreenSlidePageFragment newInstance(int pos) {
		FourPlayerScreenSlidePageFragment fragment = new FourPlayerScreenSlidePageFragment(
				pos);
	...
	public FourPlayerScreenSlidePageFragment(int pos) {
		this.pos = pos;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ViewGroup rootView = (ViewGroup) inflater.inflate(
				R.layout.four_players, container, false);
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		try {
			final ViewPager pager = ((FourPlayersActivity) getActivity())
					.getmPager();

			dealer = Dealer.getInstance();
			dealer.dealAllCards(this, 4);
	...
	public void initLayout() throws Exception {
		...
		HandRecorder hand_recorder = ((FourPlayersActivity) getActivity())
				.getHand_recorder();
		...
		CardPairView cardPairPlayerThree = (CardPairView) getView()
				.findViewById(R.id.pair_player3);
		dealer.placeCardsToPlayer(getResources(), hand_resulter,
				cardPairPlayerThree, Dealer.PLAYER_THREE);

		CardPairView cardPairPlayerFour = (CardPairView) getView()
				.findViewById(R.id.pair_player4);
		dealer.placeCardsToPlayer(getResources(), hand_resulter,
				cardPairPlayerFour, Dealer.PLAYER_FOUR);
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				if (event.getActionMasked() == MotionEvent.ACTION_DOWN) {
					if (!river_displayed && flop_displayed && turn_displayed) {
						...
						((FourPlayersActivity) getActivity())
								.highlighWinnerPanel("");

						try {
							ResultHand winnerResult = hand_resulter
									.resultingFourPlayers();
							...
							resultGuess(String.valueOf(winnerResult
									.getNum_player()));
							((FourPlayersActivity) getActivity())
									.getHand_recorder().saveWinnerHand(
											winnerResult);
							List<Card> handPlayer1 = hand_resulter
									.getCards_player1();
							((FourPlayersActivity) getActivity())
									.getHand_recorder().addHand(handPlayer1);
							((FourPlayersActivity) getActivity())
									.getHand_recorder().saveToFile(
											getActivity(),
											HandRecorder.DATA_FILE_THREE_PLAYERS);
	...
	public void addButtonListener() {
		...
		txtNextHand.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ViewPager parentPager = ((FourPlayersActivity) getActivity())
						.getmPager();
...
//						setCurrent_player_predictions("1");
	...
	//					setCurrent_player_predictions("2");
		...
		RadioButton radioPlayer4 = (RadioButton) getView().findViewById(R.id.board3_radio_player4);
	...
	private void cleanRadioSelection() {
		RadioButton radioPlayer1 = (RadioButton) getView().findViewById(
				R.id.board3_radio_player1);
		RadioButton radioPlayer2 = (RadioButton) getView().findViewById(
				R.id.board3_radio_player2);
		RadioButton radioPlayer3 = (RadioButton) getView().findViewById(
				R.id.board3_radio_player3);
		RadioButton radioPlayer4 = (RadioButton) getView().findViewById(
				R.id.board3_radio_player4);
